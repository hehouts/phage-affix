...
#SBATCH -J sgcv111                   # Job name (limit character usage)
#SBATCH -e batch.err               # batch script's standard error file
#SBATCH -o batch.out               # batch script's standard output file
#SBATCH --time=00-2:59:00          # time allocated to this job FORMAT: dd-hh:mm:ss
...
conda init
conda activate sgc
python -m spacegraphcats run config_mvx_k11_r1.yml extract_contigs extract_reads --nolock